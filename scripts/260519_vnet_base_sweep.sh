...
# ============================================================
# Experiment: VNet base sweep
# Script name : 260519_vnet_base_sweep.sh
# Date        : 2026-05-19
#
# Sweep:
# - VNET_BASE = 32, 64, 128
...
# Base configs
# -------------------------------
VNET_BASE_LIST=(32 64 128)
VNET_BASE=${VNET_BASE_LIST[$SLURM_ARRAY_TASK_ID]}
...
# Run naming
# -------------------------------
EXP_ID="260519_vnet_base${VNET_BASE}"
RUN_ID="${EXP_ID}_${SLURM_JOB_ID}"

CKPT_DIR="${PROJECT_ROOT}/results/vnet/base_sweep/${EXP_ID}"
LOG_RUN_DIR="${PROJECT_ROOT}/logs/vnet/base_sweep/${EXP_ID}"
